...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPreorder.transaction_id'
        db.add_column('preorder_custompreorder', 'transaction_id',
    ...
    def backwards(self, orm):
        # Deleting field 'CustomPreorder.transaction_id'
        db.delete_column('preorder_custompreorder', 'transaction_id')
