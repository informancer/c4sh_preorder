...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tshirt'
        db.create_table('preorder_tshirt', (
            ('custompreorderticket_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['preorder.CustomPreorderTicket'], unique=True, primary_key=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('preorder', ['Tshirt'])


    def backwards(self, orm):
        # Deleting model 'Tshirt'
        db.delete_table('preorder_tshirt')
