...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPreorderTicket.sortorder'
        db.add_column('preorder_custompreorderticket', 'sortorder',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Tshirt.sortorder'
        db.delete_column('preorder_tshirt', 'sortorder')


    def backwards(self, orm):
        # Deleting field 'CustomPreorderTicket.sortorder'
        db.delete_column('preorder_custompreorderticket', 'sortorder')


        # User chose to not deal with backwards NULL issues for 'Tshirt.sortorder'
        raise RuntimeError("Cannot reverse this migration. 'Tshirt.sortorder' and its values cannot be restored.")
