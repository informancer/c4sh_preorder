...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'preorder_merchandise', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'preorder', ['Merchandise'])

        # Adding field 'Tshirt.merchandise'
        db.add_column(u'preorder_tshirt', 'merchandise',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['preorder.Merchandise']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Merchandise'
        db.delete_table(u'preorder_merchandise')

        # Deleting field 'Tshirt.merchandise'
        db.delete_column(u'preorder_tshirt', 'merchandise_id')
