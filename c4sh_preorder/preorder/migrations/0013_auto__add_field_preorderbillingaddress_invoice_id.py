...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreorderBillingAddress.invoice_id'
        db.add_column(u'preorder_preorderbillingaddress', 'invoice_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreorderBillingAddress.invoice_id'
        db.delete_column(u'preorder_preorderbillingaddress', 'invoice_id')
    ...
    models = {
        ...
        u'preorder.preorderbillingaddress': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
