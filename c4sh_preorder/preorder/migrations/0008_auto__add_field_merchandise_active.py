...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchandise.active'
        db.add_column(u'preorder_merchandise', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchandise.active'
        db.delete_column(u'preorder_merchandise', 'active')
