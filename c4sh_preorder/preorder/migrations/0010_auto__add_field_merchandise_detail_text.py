...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchandise.detail_text'
        db.add_column(u'preorder_merchandise', 'detail_text',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchandise.detail_text'
        db.delete_column(u'preorder_merchandise', 'detail_text')
