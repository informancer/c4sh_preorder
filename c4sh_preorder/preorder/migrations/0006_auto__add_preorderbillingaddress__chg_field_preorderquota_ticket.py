...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreorderBillingAddress'
        db.create_table('preorder_preorderbillingaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('preorder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['preorder.CustomPreorder'])),
        ...
        db.send_create_signal('preorder', ['PreorderBillingAddress'])


        # Changing field 'PreorderQuota.ticket'
        db.alter_column('preorder_preorderquota', 'ticket_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['preorder.CustomPreorderTicket']))

    def backwards(self, orm):
        # Deleting model 'PreorderBillingAddress'
        db.delete_table('preorder_preorderbillingaddress')


        # Changing field 'PreorderQuota.ticket'
        db.alter_column('preorder_preorderquota', 'ticket_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['preorder.PreorderTicket']))
    ...
    models = {
        ...
        'preorder.custompreorderticket': {
            'Meta': {'ordering': "['sortorder']", 'object_name': 'CustomPreorderTicket', '_ormbases': ['preorder.PreorderTicket']},
        ...
        'preorder.preorderbillingaddress': {
            ...
            'preorder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['preorder.CustomPreorder']"}),
        ...
        'preorder.preorderquota': {
            ...
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['preorder.CustomPreorderTicket']"})
        },
        ...
        'preorder.tshirt': {
            'Meta': {'ordering': "['sortorder']", 'object_name': 'Tshirt', '_ormbases': ['preorder.CustomPreorderTicket']},
