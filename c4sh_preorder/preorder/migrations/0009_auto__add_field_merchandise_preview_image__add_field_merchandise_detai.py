...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchandise.preview_image'
        db.add_column(u'preorder_merchandise', 'preview_image',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Merchandise.detail_url'
        db.add_column(u'preorder_merchandise', 'detail_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchandise.preview_image'
        db.delete_column(u'preorder_merchandise', 'preview_image')

        # Deleting field 'Merchandise.detail_url'
        db.delete_column(u'preorder_merchandise', 'detail_url')
